...
class AddHallDialog(QtWidgets.QDialog):
    ...
    def _on_accept(self):
        ...
        if self.places_total_input.text() == "0":
            ...
            "Provera ukupnog broja mesta", "Polje mora biti popunjeno!", QtWidgets.QMessageBox.Ok)
            return
        elif int(self.places_total_input.text()) > 100000:
            QtWidgets.QMessageBox.warning(self, 
            "Provera ukupnog broja mesta", "Polje mora biti manje od 100000!", QtWidgets.QMessageBox.Ok)
            return
        elif int(self.places_total_input.text()) % 100 != 0:
            QtWidgets.QMessageBox.warning(self, 
            "Provera ukupnog broja mesta", "Polje mora biti deljiv sa 100!", QtWidgets.QMessageBox.Ok)
            return
