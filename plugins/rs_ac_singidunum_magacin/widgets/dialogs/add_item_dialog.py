...
class AddItemDialog(QtWidgets.QDialog):
    """ 
    Dijalog za dodavanje novog proizvoda u Magacin.
    """
    def __init__(self, hall, parent=None):
        """ 
        Inicijalizator dijaloga za dodavanje novog proivoda u Magacin.
        ...
        self.expiration_date.setText("Rok upotrebe proizvoda")
        ...
        self.temperature.setText("Temperatura za čuvanje proizvoda")
    ...
    def _on_accept(self):
        ...
        if int(self.item_count_input.text()) <= 0: 
            ...
            "Provera ukupnog broja mesta", "Polje Količina mora biti popunjeno!", QtWidgets.QMessageBox.Ok)
            return
        elif int(self.item_count_input.text()) > int(self.num_of_places()): 
            QtWidgets.QMessageBox.warning(self, 
            "Provera ukupnog broja mesta", "Nema toliko mesta! Broj preostalih mesta je: "+str(self.num_of_places()), QtWidgets.QMessageBox.Ok)
            return
    ...
    def _set_temperature(self):
        """
        Metoda koja odredjuje limit za temperaturu čuvanja proizvoda.
        """
