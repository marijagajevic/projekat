...
class ItemDialog(QtWidgets.QDialog):
    ...
    """
    def __init__(self,hall_service, selected_hall, parent=None):
        """
    ...
    def _set_toolbar(self):
        ...
        self.add_item = QtWidgets.QPushButton(QIcon("resources/icons/plus.png"), "Dodaj proizvod")
        self.delete_item = QtWidgets.QPushButton(QIcon("resources/icons/minus.png"), "Ukloni proizvod")
    ...
    def _populate_table(self):
        ...
        self.items_table.setHorizontalHeaderLabels(
            ["Ime proizvoda", "Rok upotrebe proizvoda", "Temperatura za cuvanje", "Kolicina", "Hala"])
    ...
    def _on_add(self):
        ...
        if answer != 0:
            ...
            if provera:
                ...
                self.item_service.edit_item(obj)
            self.hall.places_filled += obj.item_count
            self.hall_service.edit_hall(self.hall)
            self._populate_table()
